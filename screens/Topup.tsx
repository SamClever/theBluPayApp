    ...
    <View style={[styles.area, { backgroundColor }]}>
      <View style={[styles.container, { backgroundColor }]}>
        <View style={{ backgroundColor: headerBg, borderRadius: 10, marginBottom: 10 }}>
          <Header title="Top Up" style={{ backgroundColor: headerBg }} />
        </View>
        ...
        <View style={styles.optionsContainer}>
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            onPress={() => navigation.navigate('TopupMobileMoney')}
          >
          ...
          >
            ...
            <Text style={[styles.optionText, { color: optionTextColor }]}>Bank Request</Text>
          </TouchableOpacity>
        </View>
